...
if __name__ == '__main__':
    ...
    p = 3
    out_file = "Graph 3/output/p3.txt"
    ...
    with open(out_file, "a") as f:
        ...
        for gamma0, beta0 in zip(gamma, beta):
            ...
            f.write("cut fraction: %s\n" %(str(0.5-objective(x0,p,pre_H,pre_H1,pre_H2,pre_r1)),))
            f.flush()

            # optimize the objective function
            finish = 0
            res = minimize(objective, x0, args=(p,pre_H,pre_H1,pre_H2,pre_r1), bounds=bounds,callback=callback)
